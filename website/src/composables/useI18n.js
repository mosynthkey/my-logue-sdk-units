...
export const japanesePluginDescriptions = {
  ...
  tapeosc: "tape motorの始動を再現するVarispeed oscillatorです。NTS-1 / microKORG2の帯域制限波形（saw / square / triangle / sine）をテープ速度で再生します。STARTはms。ノートオンでモーターが回り、離鍵後の音量はホストのアンプEGが決めます。WOWは0-100%です。",
