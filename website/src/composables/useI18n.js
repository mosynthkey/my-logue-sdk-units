...
export const japanesePluginDescriptions = {
  ...
  tapeosc: "tape motorのstart/stopを再現するVarispeed oscillatorです。NTS-1 / microKORG2の帯域制限波形（saw / square / triangle / sine）をテープに書いて減速します。START/STOPはms、WOWは0-100%、Unisonはオシレータ数1-8、Detuneは0-100%です。",
